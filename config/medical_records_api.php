...
if (!function_exists('ems_medical_center_normalize_record')) {
    function ems_medical_center_normalize_record(array $record, ?PDO $pdo = null): array
    {
        ...
        $mapped = [
            ...
            'remote_general_condition' => ems_medical_center_scalar_text($get(['keadaan_umum', 'general_condition', 'kesadaran', 'consciousness'])),
                        'remote_gcs' => ems_medical_center_scalar_text($get(['gcs'])),
