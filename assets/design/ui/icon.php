...
function ems_icon(string $name, string $classes = 'h-5 w-5', string $stroke = '1.8'): string
{
    $paths = [
        ...
        'user-minus' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632ZM14.25 9.75h-6" />',
