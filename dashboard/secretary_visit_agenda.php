    ...
    <div class="page page-shell">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div class="card card-section">
                ...
                <form method="POST" action="secretary_action.php" enctype="multipart/form-data" class="form" onsubmit="return secretaryShowLoading('Menyimpan Agenda', 'Mohon tunggu, agenda dan lampiran sedang diupload dan diproses.');">
                    <?= csrfField(); ?>
                    ...
                    <div class="doc-upload-wrapper m-0">
                        ...
                        <div class="doc-upload-input">
                            ...
                            <input type="file" id="visitAgendaAttachments" name="attachments[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.txt,image/jpeg,image/png,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain" class="sr-only" multiple>
                    ...
                    <div id="visitAgendaAttachmentContentWrapper" style="display:none;">
                        ...
                        <textarea name="attachment_content" id="visitAgendaAttachmentContent" rows="5" placeholder="Ketik ulang isi lengkap lampiran ini apa adanya..."></textarea>
                    </div>
...
<div id="visitAgendaEditModal" class="modal-overlay hidden">
    <div class="modal-box modal-shell modal-frame-lg">
        ...
        <div class="modal-content">
            <form method="POST" action="secretary_action.php" enctype="multipart/form-data" class="form" onsubmit="return secretaryShowLoading('Menyimpan Perubahan', 'Mohon tunggu, perubahan agenda dan lampiran sedang disimpan.');">
                <?= csrfField(); ?>
                ...
                <div class="doc-upload-wrapper m-0">
                    ...
                    <div class="doc-upload-input">
                        ...
                        <input type="file" id="editVisitAgendaAttachments" name="attachments[]" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx,.txt,image/jpeg,image/png,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain" class="sr-only" multiple>
                ...
                <div id="editVisitAgendaAttachmentContentWrapper" style="display:none;">
                    ...
                    <textarea name="attachment_content" id="editVisitAgendaAttachmentContent" rows="5" placeholder="Ketik ulang isi lengkap lampiran baru ini apa adanya..."></textarea>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    setupMultiImagePreview('visitAgendaAttachments', 'visitAgendaAttachmentsPreview', 'visitAgendaAttachmentContentWrapper');
    setupMultiImagePreview('editVisitAgendaAttachments', 'editVisitAgendaAttachmentsPreview', 'editVisitAgendaAttachmentContentWrapper');
    ...
    document.addEventListener('click', function (event) {
        ...
        if (editButton) {
            ...
            resetMultiImagePreview('editVisitAgendaAttachments', 'editVisitAgendaAttachmentsPreview', 'editVisitAgendaAttachmentContentWrapper');
