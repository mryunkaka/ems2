...
<section class="content">
    ...
    <div class="page page-shell">
        ...
        <?php foreach ($messages as $m): ?>
            <?= ems_render_toast_script((string)$m, 'info', 'Rekap Farmasi') ?>
        <?php endforeach; ?>
        <?php foreach ($warnings as $w): ?>
            <?= ems_render_toast_script((string)$w, 'warning', 'Rekap Farmasi') ?>
        <?php endforeach; ?>
        <?php foreach ($errors as $e): ?>
            <?= ems_render_toast_script((string)$e, 'error', 'Rekap Farmasi', 6800) ?>
        <?php endforeach; ?>
